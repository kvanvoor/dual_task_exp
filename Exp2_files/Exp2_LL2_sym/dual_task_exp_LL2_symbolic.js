...
newTrial("start_practice",
    newText("space","<p> When you're ready to begin, you're going to see two letters to store in your memory and you'll have to type them back in at the end of the trial in BACKWARDS order.</p>")
    .settings.css("font-size", "x-large")
    .print(),
