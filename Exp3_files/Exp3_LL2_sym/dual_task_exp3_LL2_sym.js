...
PennController("welcome",
    newHtml("welcome", "dual_task_welcome_LL2.html")
        .print(),
...
PennController("instructions",
    newHtml("instructions", "dual_task_instructions_LL2.html")
        .print(),
    newButton("continue_button", "continue")
        .print()
        .wait()
    ...
    getHtml("instructions")
        .remove(),
    newHtml("instructions_FJ", "dual_task_instructions_FJ.html")
        .print(),
    newButton("continue_practice_button", "Click to begin practice session.")
        .print()
        .wait()
        .remove(),
    fullscreen(),
    getHtml("instructions_FJ")
        .remove()
)
...
newTrial("start_practice",
    newText("space","<p>When you're ready to begin, you're going to see two letters to store in your memory and you'll have to type them back in at the end of the trial.</p>")
    .settings.css("font-size", "x-large")
    .print(),
...
//practice block
Template("dual_task_practice_LL2_symbolic.csv", row =>
    newTrial("practice_block",
       ...
       newText("frameF", " [ F ] ")
        ...
        newText("Agree", "Agree")
             .italic()
             .print(),
        newText("Disagree", "Disagree")
             .italic()
             .print(),
        newText("answer", "Press the key 'F' (Disgree) or the key 'J' (Agree) to answer.")
              .settings.css("font-size", "medium")
              .italic()
              .print(),
        newCanvas("scale_target", 700, 120)
            .add(140 ,40 , getText("frameF"))
            .add(140, 70 , getText("Disagree"))
            .add(445 , 40, getText("frameJ"))
            .add(445 , 70, getText("Agree"))
            .add("center at 50%", 110, getText("answer"))
            .log()
        ...
        getText("sentence")
            .remove(),
        newText("memory_task", "Please enter the letters you saw before:")
        ...
        getTextInput("sequence")
            ...
            .failure(newText("incorrect", "Wrong, the correct sequence is "+row.rep_1)
                    ...
                    newText("hint", "Hint: Other participants found it helpful to start rehearsing the right answer as soon as the letters are presented.").center().settings.css("font-size", "large").print())
...
//experiment block 1
Template("dual_task_sentence_LL2_symbolic.csv", row =>
    newTrial("experiment",
        newText("3", "+")
            .settings.css("font-size", "xxx-large")
            .color("red")
